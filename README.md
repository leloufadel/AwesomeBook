...
<details>
  ...
  <ul>
    ...
    <li><a href="https://www.tutorialspoint.com/css/css3_tutorial.htm#:~:text=Cascading%20Style%20Sheets%20(CSS)%20is,Namespaces"></a>CSS3</li>
    <li><a href="https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&cad=rja&uact=8&ved=2ahUKEwjj-Ku-0NH-AhWYR_EDHSPHAsgQFnoECB0QAQ&url=https%3A%2F%2Fwww.w3schools.com%2Fjs%2FDEFAULT.asp&usg=AOvVaw3k7TaT8R3-JGc_Dt_BMh5M"></a>JavaScript</li>
  </ul>
</details>
...
```sh
  cd my-folder
  git clone git@github.com:VaheStepanyan100/awesome-books.git
```
